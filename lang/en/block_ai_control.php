...
$string['addblockinstance'] = 'Add AI control center';
$string['addblockinstance_help'] = 'Adds the block "AI control center" to the course';
$string['ai_control:addinstance'] = 'Add AI control center';
$string['ai_control:control'] = 'Make configurations in AI control center';
$string['ai_control:myaddinstance'] = 'AI control center to the dashboard';
$string['ai_control:view'] = 'Show AI control center';
$string['ai_control_config_changed'] = 'Configuration of an AI control center block has been changed';
$string['ai_control_config_changed_desc'] = 'This event is being fired if the configuration of an AI control center block has been changed. This way it is trackable which instructor changed the configuration in which way.';
$string['aidisabled'] = 'AI disabled';
$string['aienabled'] = 'AI enabled';
